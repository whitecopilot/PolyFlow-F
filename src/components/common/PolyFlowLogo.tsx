...
export function PolyFlowLogo({
  ...
  // 根据颜色模式决定填充色
  const fillColor = colorMode === 'white'
    ? 'white'
    : colorMode === 'currentColor'
      ? 'currentColor'
      : 'url(#polyflow-logo-gradient)'
      ...
      >
        {colorMode === 'gradient' && (
          <defs>
            ...
            >
              <stop stopColor="#292FE1" />
              <stop offset="1" stopColor="#C20ED7" />
            </linearGradient>
          </defs>
        )}

        {/* 右侧圆点 */}
        <circle cx="17.5" cy="14.5" r="2.5" fill={fillColor} />
